...
import { Element as Element$1, Path, Node, Transforms, Editor, Text, Range, Point, createEditor } from 'slate';
import { assertNever as assertNever$1, assert as assert$1 } from 'emery/assertions';
import { assert, assertNever } from 'emery';
import { fromUint8Array } from 'js-base64';
import { b as bytesToHex } from './hex-2b4d164f.react-server.esm.js';
import { T as TextFieldInput, D as DocumentFieldInput } from './empty-field-ui-1936cae8.react-server.esm.js';
...
function withCodeBlock(documentFeatures, componentBlocks, editor) {
  ...
  editor.insertBreak = () => {
    ...
    if ((block === null || block === void 0 ? void 0 : block[0].type) === 'code' && Text.isText(block[0].children[0])) {
...
export { getWholeDocumentFeaturesForChildField as $, getInitialPropsValueFromInitializer as A, aliasesToLabel as B, aliasesToCanonicalName as C, canonicalNameToLabel as D, labelToCanonicalName as E, languagesWithAliases as F, transformProps as G, getValueAtPropPath as H, cloneDescendent as I, areArraysEqual as J, KEYSTATIC_CLOUD_API_URL as K, getSchemaAtPropPath as L, findChildPropPaths as M, object as N, getSelectedTableArea as O, getRelativeRowPath as P, cell as Q, clearFormatting as R, EditorAfterButIgnoringingPointsWithNoContent as S, getInlineNodes as T, addMarksToChildren as U, setLinkForChildren as V, forceDisableMarkForChildren as W, addMarkToChildren as X, getPlaceholderTextForPropPath as Y, Prism as Z, _createDocumentEditor as _, KEYSTATIC_CLOUD_HEADERS as a, getEntryDataFilepath as a0, getDirectoriesForTreeKey as a1, getTreeKey as a2, blobSha as a3, updateTreeWithChanges as a4, serializeProps as a5, getSlugGlobForCollection as a6, getCollectionFormat as a7, getCollectionItemPath as a8, getDataFileExtension as a9, getSingletonFormat as aa, isCloudConfig as ab, FieldDataError as ac, basicFormFieldWithSimpleReaderParse as ad, assertRequired as ae, getSrcPrefix as af, fixPath as ag, validateText as ah, text as ai, document$1 as aj, getEntriesInCollectionWithTreeKey as b, getSingletonPath as c, getTreeNodeAtPath as d, treeSha as e, getBranchPrefix as f, getPathPrefix as g, getSplitCloudProject as h, isGitHubConfig as i, getRepoUrl as j, isLocalConfig as k, getCollectionPath as l, getKeysForArrayValue as m, nodeTypeMatcher as n, getSlugFromState as o, pluralize as p, getInitialPropsValue as q, redirectToCloudAuth as r, setKeysForArrayValue as s, treeEntriesToTreeNodes as t, updateValue as u, getAncestorComponentChildFieldDocumentFeatures as v, isBlock as w, allMarks as x, isListNode as y, isElementActive as z };
